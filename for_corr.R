...
# 데이터 불러오기
df1 <- read_csv(file = "D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time.csv", 
...
write.csv(cor_df, file = "D:/대학원/논문/소논문/부동산_토픽모델링/cor_df.csv", row.names=FALSE, fileEncoding = 'cp949')
